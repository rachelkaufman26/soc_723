...
simple_fit
```
I am going to break this down into teeny tiny basics for myself. So, our intercept exists for when our  x value is 0, so 0 years. That adds up because obviously we do not have a 0 year in the, and that is about forever away (2023 years lol). So, it being -322 doesn't tell us much, but does remind me we are on the correct track. Further, our coefficient for year is 0.201, so this would mean that for every one point increase we see in years, we can anticipate an increase a unit increase of 0.201% for the wage percent of males.  
